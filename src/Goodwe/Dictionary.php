...
class Dictionary {
    ...
    public static $GRID_MODES = [
        0 => 'Not connected to grid',
        1 => 'Connected to grid',
        2 => 'Fault',
    ];
    
    public static $GRID_IN_OUT_MODES = [
        0 => 'Idle',
        1 => 'Exporting',
        2 => 'Importing',
    ];
    
    public static $LOAD_MODES = [
        0 => 'Inverter and the load is disconnected',
        1 => 'The inverter is connected to a load',
    ];
    
    public static $PV_MODES = [
    ...
    public static $SAFETY_COUNTRIES = [
        0 => 'Italy',
        1 => 'Czechia',
        2 => 'Germany',
        3 => 'Spain',
    ...
    public static $DIAG_STATUS_CODES = [
    ...
    public static $BMS_WARNING_CODES = [
    ...
    public static $METER_STATUS_CODES = [
        0 => 'Not checked',
        1 => 'Correct',
        2 => 'Reverse',
        3 => 'Incorrect',
    ...
    public static $METER_COMMUNICATION_CODES = [
        0 => 'Not OK',
        1 => 'OK',
    ];
